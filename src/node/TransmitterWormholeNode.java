...
public class TransmitterWormholeNode extends AbstractPlaceableFlowableNode implements TransmitterWormholeInterface {

	public TransmitterWormholeNode(float x, float y) {
		super(x, y);
	}
